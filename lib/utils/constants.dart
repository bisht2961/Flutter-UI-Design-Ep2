...
const TextTheme TEXT_THEME_DEFAULT = TextTheme(
    headline1: TextStyle(
        color: COLOR_WHITE, fontWeight: FontWeight.w400, fontSize: 30),
    headline2: TextStyle(
        color: COLOR_WHITE, fontWeight: FontWeight.w400, fontSize: 26),
    headline3: TextStyle(
        color: COLOR_WHITE, fontWeight: FontWeight.w400, fontSize: 22),
    headline4: TextStyle(
        color: COLOR_WHITE, fontWeight: FontWeight.w400, fontSize: 18),
    headline5: TextStyle(
        color: COLOR_WHITE, fontWeight: FontWeight.w400, fontSize: 16),
    headline6: TextStyle(
        color: COLOR_WHITE, fontWeight: FontWeight.w400, fontSize: 14),
    bodyText1: TextStyle(
